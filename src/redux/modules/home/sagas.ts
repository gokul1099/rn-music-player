...
function* getTrackDetailsSaga({type,payload}:IAction){
...
function* getAlbumDetailsSaga({type,payload}:IAction){
...
function* getArtistDetailsSaga({type,payload}:IAction){
...
function* searchSaga({type,payload}:IAction){
